            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="form-group col-sm-10">
                            <input name="mobile_no" class="form-control" type="number" value="{{$customer->mobile_no}}"  id="mobile_no">
                        </div>
                    </div>
                    <!-- end row -->
                    ...
                    <div class="col-sm-10">
                        <img id="showImage" class="rounded avatar-lg" src="{{ (!empty($customer->logo_image)) ? asset($customer->logo_image): asset('backend/assets/images/customers/no_image.jpg') }}" alt="Profile Image">
                    </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="form-group col-sm-10" style="margin-top: 7px;">
                            ...
                            <input class="form-check-input" type="checkbox" value="{{($customer->status == 1)? "1":"0"}}" 
                              id="statusCheckBox" name="status" onclick="changeLabel();" {{($customer->status == 1)? "checked":""}}>
