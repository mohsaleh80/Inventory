                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="form-group col-sm-10">
                            <input name="name" class="form-control" type="text" value="{{$category->name}}"  id="name">
                        </div>
                    </div>
                    <!-- end row -->
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="form-group col-sm-10" style="margin-top: 7px;">
                            ...
                            <input class="form-check-input" type="checkbox" value="{{($category->status == 1)? "1":"0"}}" 
                              id="statusCheckBox" name="status" onclick="changeLabel();" {{($category->status == 1)? "checked":""}}>
                    ...
                    <br> 
                           ...
                           <input type="submit" class="btn btn-info waves-effect waves-light" style="float: right"  value="Edit Category">
