        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('category.add') }}" id="myForm" enctype="multipart/form-data">
                        @csrf
                    ...
                    <br> 
                           ...
                           <input type="submit" class="btn btn-info waves-effect waves-light" style="float: right"  value="Add Category">
