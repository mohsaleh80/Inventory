...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    ...
    <a href="{{ route('invoice.add') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fas fa-plus-circle"> Add Inovice </i></a> <br>  <br>               
            ...
            <tr>
                ...
                <td>
                    <a href=" {{route('invoice.show',$item->id)}}" class="btn btn-primary sm" title="Show" >  <i class="fas fa-check-circle"></i> </a>
                </td>    
                <!--
                <td>  
                    <a href="{{ route('invoice.destroy',$item->id) }}" class="btn btn-danger sm" title="Delete Data" id="delete">  <i class="fas fa-trash-alt"></i> </a> 
                </td>
                -->
            </tr>
                        @endforeach
