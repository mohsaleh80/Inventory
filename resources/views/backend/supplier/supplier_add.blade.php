        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('supplier.add') }}" id="myForm" enctype="multipart/form-data">
                        @csrf
                    ...
                    <div class="row mb-3">
                       ...
                       <div class="col-sm-10">
                           <img id="showImage" class="rounded avatar-lg" src="{{asset('backend/assets/images/suppliers/no_image.jpg')}}" alt="Profile Image">
                       </div>
                     </div>
                    ...
                    <br> 
                           ...
                           <input type="submit" class="btn btn-info waves-effect waves-light" style="float: right"  value="Add Supplier">
